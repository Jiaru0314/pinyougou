...
import com.pinyougou.user.service.UserDetailService;
...
public class UserDetailServiceImpl implements UserDetailService {
    ...
    public void createSmsCode(final String phone) {
        //1.生成一个6位随机数（验证码）
        final String verificationCode = (long) (Math.random() * 1000000) + "";
        ...
        jmsTemplate.send(smsDestination, new MessageCreator() {
            ...
            public Message createMessage(Session session) throws JMSException {
                ...
                message.setString("verificationCode", verificationCode);
                return message;
            }
        });
    }
    ...
    public boolean checkSmsCode(String phone, String code) {
        ...
        String systemcode = (String) redisTemplate.boundHashOps("verificationCode").get(phone);
        if (systemcode == null) {//如果redis中没有对应验证码 返回false
            return false;
        }
        if (!systemcode.equals(code)) {//如果验证码不符合返回false
            return false;
        }
        return true;
    }
